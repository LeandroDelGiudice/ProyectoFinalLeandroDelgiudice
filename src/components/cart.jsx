...
/*export const Cart = () => {
  ...
  return (
    ...
    <button style={{  fontWeight:400, color:"white",backgroundColor: "black", fontSize: '20px',borderRadius: '8px'}}onClick={clear}> Vaciar carro </button>
      <hr />
...
export const Cart = () => {
  ...
  return (
    <Container className="mt-4">
      ...
      <button
        style={{ fontWeight: 400, color: "white", backgroundColor: "black", fontSize: '20px', borderRadius: '8px' }}
        onClick={clear}
      >
        Vaciar carro
      </button>
